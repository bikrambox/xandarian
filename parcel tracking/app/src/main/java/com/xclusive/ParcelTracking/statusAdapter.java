...
class statusAdapter extends RecyclerView.Adapter<statusAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.trackitemlayout,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
          holder.textView.setText(statusModelList.get(position).getStatus());
          holder.dates.setText(statusModelList.get(position).getDates());
    }
